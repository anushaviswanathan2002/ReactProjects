...
class Counter extends Component {
  ...
  decrement = () => {
    // Validate bounds using strict comparison
    if (this.state.count <= MIN_COUNT) {
      console.warn('Minimum reached!');
      return;
    }
  ...
  // Handle setting a value via button click (only commits on valid input)
  handleSetValueClick = () => {
      ...
      <div className="counter-container">
        ...
        <div className="counter-content">
          ...
          <div className="button-group">
            ...
            {this.renderButton('Set Value', this.handleSetValueClick, '#2196F3')}
          </div>
